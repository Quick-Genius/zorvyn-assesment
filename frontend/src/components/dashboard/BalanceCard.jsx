    ...
    <div className="md:col-span-2 lg:col-span-1 bg-surface-container-lowest dark:bg-stone-900 p-6 rounded-xl editorial-shadow relative overflow-hidden group">
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
          <span className="text-sm font-medium text-stone-500 dark:text-stone-400">My Balance</span>
          <div className="flex items-center gap-1 text-primary dark:text-green-400 bg-primary-container/10 dark:bg-green-900/20 px-2 py-0.5 rounded-full text-xs font-bold">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex-1 border border-outline-variant/30 dark:border-stone-700 text-on-surface dark:text-stone-200 text-xs font-bold py-3 rounded-lg hover:bg-stone-50 dark:hover:bg-stone-800 transition-colors">
            Request
          </button>
        </div>
      </div>
