function AllocationDonut() {
  const allocations = [
    ...
    { name: 'Savings', percentage: 20, color: 'bg-stone-200' },
  ];
  
  return (
    <div className="col-span-12 lg:col-span-4 bg-surface-container-lowest rounded-xl p-6 shadow-[0_20px_40px_-12px_rgba(25,28,27,0.06)] flex flex-col">
      <h3 className="text-stone-500 text-sm font-label uppercase tracking-wider mb-6">Allocation Breakdown</h3>
      <div className="relative flex items-center justify-center mb-8">
        <svg className="w-48 h-48 transform -rotate-90">
          <circle className="text-stone-100" cx="96" cy="96" r="80" fill="transparent" stroke="currentColor" strokeWidth="20"></circle>
        ...
        <div className="absolute flex flex-col items-center">
          <span className="text-3xl font-bold font-manrope">$4,820</span>
