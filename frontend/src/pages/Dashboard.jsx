...
import { monthlyChartData, weeklyChartData, expenseCategories } from '../data/mockCharts';
  ...
  return (
    <div className="grid grid-cols-12 gap-8">
      <section className="col-span-12 lg:col-span-8 space-y-8">
        <div>
          <h1 className="text-3xl font-headline font-extrabold tracking-tight text-on-surface dark:text-stone-200">
            Good morning, User
          </h1>
          <p className="text-stone-500 dark:text-stone-400 mt-1">Premium Account Overview</p>
        </div>
        ...
        <FinancialChart monthlyData={monthlyChartData} weeklyData={weeklyChartData} />
        
        <div className="relative rounded-xl overflow-hidden editorial-shadow bg-gradient-to-br from-primary to-primary-container dark:from-primary dark:to-primary-container p-8 flex flex-col md:flex-row justify-between items-center">
